...
export interface ApiAcordeonAcordeon extends Struct.CollectionTypeSchema {
  collectionName: 'acordeons';
  info: {
    description: '';
    displayName: 'Acordeon';
    pluralName: 'acordeons';
    singularName: 'acordeon';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    acordeonID: Schema.Attribute.UID & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::acordeon.acordeon'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    textos: Schema.Attribute.Relation<'oneToMany', 'api::texto.texto'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCarruselCarrusel extends Struct.CollectionTypeSchema {
  collectionName: 'carrusels';
  info: {
    description: '';
    displayName: 'Carrusel';
    pluralName: 'carrusels';
    singularName: 'carrusel';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    carrusel: Schema.Attribute.Media<
      ...
      true
    >;
    carruselID: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiDocumentoDocumento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentoID: Schema.Attribute.UID & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiImagenImagen extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagenID: Schema.Attribute.UID & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::imagen.imagen'
...
export interface ApiUsinaUsina extends Struct.CollectionTypeSchema {
  collectionName: 'usinas';
  info: {
    description: '';
    displayName: 'Usina';
    pluralName: 'usinas';
